  ...
  return (
    <div className="px-4 py-16 mx-auto prose-sm sm:max-w-5xl sm:prose">
      ...
      <p>
        ...
        request-time rather than build-time. This means authors have to pay for
        and maintain a server, and as a result of not generating pages at
      ...
      <p>
        ...
        life-span of their website, an author will often add many plugins. Each
        adds complexity to the author's editing experience and requires clients
        to download yet more code making an already slow site that much slower.
        Not to mention some plugins are incompatible with some themes leading to
      ...
      <p>
        ...
        don't load with contentful markdown meaning they have horrible SEO. This
        brings us to our second keyword, <strong>server-side rendering</strong>.
        Basically, to ensure Authorize sites have good SEO I'll do their initial
        render on the server to build that contentful markdown then after the
        initial load they can just act like normal SPAs for subsequent page
        navigations.
      </p>
      <p>
        Yet again, server-side rendering solves some problems while creating new
        ones of its own. Specifically, server-side rendering requires&mdash;get
        this&mdash;a server. Because I want to host Authorize sites on a CDN
        this is a non-starter. I can get around this with our third keyword,{" "}
        <strong>build-time rendering</strong>.
      </p>
      <p>
      ...
      <p>
        ...
        SPAs will naively download the JavaScript for the entire site on their
        ...
        downloaded code not actually being necessary for the intial page.
      </p>
      <p>
        Build-time rendering solves this by having the build service note which
        code is required for each page it builds then having it split the site's
        ...
        the instant page navigations I noted earlier as a selling point of SPAs.
      </p>
      <p>
      ...
      <p>
        Authorize solves this by giving authors a headless CMS. Basically, I set
        clients up with a Wordpress like UI called a headless CMS into which
        they can add their book, series, and static page content. Then that
        headless CMS, on save, calls a webhook from the build service to trigger
        a rebuild of the site. This build service, gathers all the data from the
        CMS via a RESTful API (it's headless because it just exposes an API
        rather than a full website, aka a head), and rebuilds any pages whose
        underlying data have changed from the last build.
      </p>
      <p>
        ...
        headless CMS I'll just set clients up with a pre-configured account from
        a managed headless CMS service (currently I'm using{" "}
        <a href="" target="_blank" rel="noopener">
          Contenful
        </a>{" "}
        though this is not set in stone). Something important to note is author
        sites have next to zero content in the grand scheme of things. Even the
        most prolific authors write on the order of 100s of books, and that's
        barely a drop in the bucket for most hosted CMS services. So, the vast
        majority of clients won't have to pay a dime for their CMS since they'll
        fall well within the free plan's limits.
      </p>
      <p>
      ...
      <p>
        ...
        author. I believe this is a much bigger feature than it may seem on the
        surface&mdash;an x-factor, if you will.
      </p>
      <p>
      ...
      <p>
        ...
        expanded scope I'll likely charge this as an optional add-on. This isn't
        worked out yet. So, that's all I'll say about it in the business plan.
        However, this does bring us to the topic of pricing.
      </p>
      ...
      <p>
        ...
        things like color palettes, page titles, etc. The rest of the time will
        be spent migrating the author's old site's data over to their new site.
        This means that up front pricing will differ from author to author. My
        estimatation for this has changed based on some revenue modeling you'll
        see in a moment, but I started with $500 per author on average.
      ...
      <p>
        ...
        (currently targetting 2 hours per month). Basically, subscribers get to
        completely offload the complexity of maintaining their website to me. If
        something breaks, I'll fix it. If they need help doing something, I'll
        help walk them through it. My initial pricing for this support plan was
        $50 per month.
      </p>
      <p>
      ...
      <p>
        ...
        down the line, and it will likely be a large hurdle for sales.
      </p>
      <p>
      ...
      <p>
        ...
        next question is where does this top off. After, all <strong>I</strong>{" "}
        might be willing to work for ~$55k a year, but it'd be difficult to find
        a solid software engineer to bring on as employee number one at that
        kind of salary.
      </p>
      <p>
      ...
      <p>
        It's a bit hard to read, but you'll notice total support plans level off
        at around 130. This is the point where the number of cancelations each
        month is roughly equal to the number of new support plans added. It's
        worth noting that I estimated the cancelation rate at ~2.5% each month
        to be conservative, but I'd be shooting for a much lower number.
        Unfortunately, as you'll see in a bit, this equilibrium is considerably
        higher than my real limit since it doesn't account for how long I would
        have to work every day to maintain this client base. Anyways, if we plug
        this into our revenue model we get this:
      </p>
      ...
      <p>
        Let's check that assumption. Assuming each support plan is 25% utilized
        on average, meaning 0.5 hours of work per month per support plan, and
        each new site takes 25 hours to build that leaves us with 60 hours a
        month per employee or about 120 support plans per employee.
      </p>
      <p>
        ...
        low support utilization. If I run the same numbers at 75% utilization it
        comes out to 40 support plans per employee which is too low to support
      ...
      <p>
        ...
        Rerunning the numbers that leaves engineers with 140 hours per month for
        support. Which, even at 75% utilization, is 93 support plans per
        engineer or about $83k per year per engineer which is a workable revenue
        per employee number.
      </p>
      <p>
        ...
        anything about what the market can bear at different price points, only
        what different price points would equate to in revenue should the market
        bear them all equally.
      </p>
      <p>
      ...
      <p>
        ...
        important as the number of support plans grows. Interestingly, this
        effect only really appears many years into the simulation meaning the
        early adavantages of a higher up front price aren't as short lived as I
        would have thought.
      </p>
      <p>
      ...
      <p>
        What's interesting is that this model leads to a higher monthly revenue
        than the doubled up front revenue model by only the 14th month (give or
        take a few months), and in the long term it leads to a considerably
        higher $15,000 per month of revenue or $180,000 per year (an ~80%
        increase).
      </p>
      <p>
      ...
      <p>
        ...
        per new site on average and $25 per month for the first 16 months then
        assuming my predictions hold (which I'm sure they won't) I'll start
        raising the monthly price in $5 incremenents each month for 15 months
        ending at 100 per month on month 31. Additionally, I'll start lowering
        the up front price in $50 increments each month starting on month 21 and
        ending on month 31. This all assumes the market can bear at least 1
        person's full work-load at these prices. Based on some basic research, I
        think this is a reasonable assumption. So, with this plan in place
        here's what my revenue projection looks (this one is not randomized):
      </p>
      ...
      <p>
        Because I want to optimize CLV, I will be targeting mid-list authors. As
        I see it there are three breeds of authors. Beginner, mid-list, and
        ...
        build and maintain a completely custom site. While that's a high margin
        niche, it's not my niche.
      </p>
      <p>
      ...
      <p>
        ...
        Authorize site which I'll give to anyone I part ways with. It will give
        general hosting info, but also a step-by-step guide for the services I
        use to host sites. The idea being that they can completely duplicate my
        deployment setup on their own with a bit of work.
      </p>
      <p>
      ...
      <p>
        ...
        I have clients on my books will be a messy process. However, I think
        these mitigations should temper the worst of the possible problems with
        this eventuality.
      </p>
      <p>
        ...
        even if my company isn't successful. This is an ideal solution, but it
        remains to be seen if any companies in the space will be willing to take
        on the risks associated doing this.
      </p>
    </div>
  );
}
